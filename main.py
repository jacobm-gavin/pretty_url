...
def index():
    if request.method == 'POST':
        ...
        dbCursor = dbc.db(('userlinks.db'))
        dbCursor.enterLinkIntoDatabase(original_link, short_link)
...
def redirect_short_link(short_link_hash):
    ...
    original_link = dbCursor.getFullLinkFromShortLink(short_link_hash)
    print(original_link, "JKFJDFLKDSJFLKSDJFLKDS:JFKL:DSF")
